package com.pelegrino.listadetarefas
...
import com.pelegrino.listadetarefas.ui.TaskListAdapter
...
class  MainActivity : AppCompatActivity() {
    ...
    private fun updateList() {
        ...
        binding.emptyState2.emptyState.visibility = if (list.isEmpty()) View.VISIBLE
        else View.GONE
